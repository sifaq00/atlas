    ...
    <section className="py-24" id="features">
      <div className="max-w-[1220px] mx-auto px-6">
        <div className="flex justify-between items-end gap-6 flex-wrap">
          <div>
            <span className="font-mono text-[11.5px] tracking-[0.14em] uppercase font-semibold text-ink-soft block mb-2">Features</span>
            <h2 className="text-[clamp(28px,3.8vw,46px)] leading-[1.1] tracking-[-0.03em] font-bold mt-3.5 text-ink">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[18px] mt-[46px]">
          {/* Feature 1 */}
          <div className="rounded-[22px] border border-line p-7 bg-white transition-all duration-200 ease-in-out flex flex-col hover:-translate-y-1.5 hover:shadow-[0_24px_50px_rgba(9,40,72,0.10)]">
            <div className="w-11 h-11 bg-lime-brand rounded-xl flex items-center justify-center mb-5 shrink-0">
            ...
            <h3 className="text-[21px] tracking-[-0.02em] font-bold text-ink">The Map</h3>
            <p className="text-[14.5px] leading-[1.6] text-ink-soft mt-2.5 flex-1">
            ...
            <span className="mt-6 inline-block font-mono text-[10.5px] tracking-[0.1em] uppercase bg-mist rounded-full py-1.5 px-3 text-ink-soft w-fit">Sidebar panel</span>
          </div>
          ...
          <div className="rounded-[22px] border border-line p-7 bg-white transition-all duration-200 ease-in-out flex flex-col hover:-translate-y-1.5 hover:shadow-[0_24px_50px_rgba(9,40,72,0.10)]">
            ...
            <h3 className="text-[21px] tracking-[-0.02em] font-bold text-ink">Start Here</h3>
            <p className="text-[14.5px] leading-[1.6] text-ink-soft mt-2.5 flex-1">
            ...
            <span className="mt-6 inline-block font-mono text-[10.5px] tracking-[0.1em] uppercase bg-mist rounded-full py-1.5 px-3 text-ink-soft w-fit">Ranked list</span>
          </div>
          ...
          <div className="rounded-[22px] border border-line p-7 bg-white transition-all duration-200 ease-in-out flex flex-col hover:-translate-y-1.5 hover:shadow-[0_24px_50px_rgba(9,40,72,0.10)]">
            ...
            <h3 className="text-[21px] tracking-[-0.02em] font-bold text-ink">Blast Radius</h3>
            <p className="text-[14.5px] leading-[1.6] text-ink-soft mt-2.5 flex-1">
              Change one file and instantly see every downstream file that imports it — directly or through three layers of re-exports.
            </p>
            <span className="mt-6 inline-block font-mono text-[10.5px] tracking-[0.1em] uppercase bg-mist rounded-full py-1.5 px-3 text-ink-soft w-fit">Impact preview</span>
          </div>
        </div>
      </div>
    </section>
